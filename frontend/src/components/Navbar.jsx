...
>
  ...
  <div className="relative shrink-0">
    ...
    <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-400 
                     rounded-full border-2 border-white animate-pulse" />
  </div>

  {/* Username + Email */}
  <div className="hidden md:flex flex-col justify-center text-left w-[160px]">
  ...
  />
                ...
                {menuOpen &&(
                    <ul className='absolute top-14  right-0 w-56 bg-white rounded-2xl shadow-xl border-purple-100 z-50 overflow-hidden animate-fadeIn'>
                        ...
                        <li className='p-2'>
                            <button onClick={handleLogout} className=' flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-red-50 text-red-600'role=''>
