...
import { EyeOff,Eye,Lock,Mail,LogIn } from 'lucide-react'
...
const Login = ({onSubmit,onSwitchMode}) => {
  ...
  const handleSubmit=async(e)=>{
    ...
    try {
      ...
      toast.success("Login succeesfull Redirecting..")
  ...
  return (
    <div className='max-w-md bg-white w-full shadow-lg border-purple-100 rounded-xl p-8'>
      ...
      <p className='text-center text-sm text-gray-600 mt-6'>
        ...
        <button type='button' className='text-purple-500 hover:text-purple-700 hover:underline
