...
import { ChevronLeft, UserCircle,Save, LogOut,Shield ,Lock} from 'lucide-react'
...
useEffect(() => {
    ...
    <div className='min-h-screen bg-gray-50'>
        ...
        <div className='max-w-4xl mx-auto p-6'>
            ...
            <div className='flex items-center gap-4 mb-8'>
                <div className='h-16 w-16 rounded-full bg-gradient-to-br  from-fuchsia-500 to-purple-600  flex items-center justify-center text-white text-2xl font-bold shadow-md'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
                <section className={SECTION_WRAPPER}>
                    <div className='flex items-center gap-2 mb-6'>
                        ...
                        <h2 className='text-xl font-semibold text-gray-800'>Personal Informattion</h2>
                    </div>
  ...
  <form onSubmit={changePassword} className="space-y-4">
    ...
    <div className='mt-8 pt-6 border-t border-purple-100'>
        <h3 className='text-red-600 font-semibold mb-4 flex items-denter gap-2'>
