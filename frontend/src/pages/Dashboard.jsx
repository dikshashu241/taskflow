...
import { ADD_BUTTON,SELECT_CLASSES,FILTER_OPTIONS,EMPTY_STATE,TABS_WRAPPER,TAB_BASE,TAB_ACTIVE,TAB_INACTIVE, HEADER,STAT_CARD,ICON_WRAPPER,VALUE_CLASS, STATS, WRAPPER ,STATS_GRID, LABEL_CLASS, FILTER_WRAPPER, FILTER_LABELS} from "../assets/dummy"
  ...
  {filteredTasks.length === 0 ? (
    ...
    filteredTasks.map((task) => (
      <TaskItem
        ...
        showCompleteCheckbox onEdit={()=>{setSelectedTask(task);setShowModal(true)}}
      />
    ))
  )}
</div>
